...
const features = [{
  ...
  icon: Zap,
  title: "Whole-House Backup",
  subtitle: "from a Single System"
}, {
  icon: Sun,
  title: "Connects to",
  subtitle: "Your Solar"
...
export const HeroSection = () => {
  return <section id="overview" className="relative min-h-[90vh] flex items-center overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <img src={heroImage} alt="Modern home with solar panels and battery storage" className="w-full h-full object-cover" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        duration: 0.8
          ...
          duration: 0.6
            ...
            <span className="text-gradient text-[#e6e6e6]">Home Battery Upgrade</span>
          </motion.h1>
