          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {appliances.map((appliance, index) => (
              <motion.div
                ...
                className="flex flex-col items-center gap-2 sm:gap-3 p-3 sm:p-4 rounded-xl bg-white shadow-[0_0_0_3px_#efb218,0_0_0_6px_#f87171] hover:shadow-[0_0_0_3px_#d4a016,0_0_0_6px_#ef4444] hover:scale-[1.02] transition-all duration-300"
              >
