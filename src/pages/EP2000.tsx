...
const features = [{
  ...
  description: "Designed for larger homes and commercial applications"
}, {
  icon: Zap,
  title: "20kW Output",
  description: "Industrial-grade power output for demanding loads"
}, {
  icon: Shield,
  title: "Advanced BMS",
  description: "Intelligent battery management for optimal performance"
}, {
  icon: Building2,
  title: "Commercial Ready",
  description: "Perfect for businesses and large properties"
}];
const essFeatures = [{
  icon: Sun,
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              delay: 0.2
                ...
                <div className="relative rounded-2xl overflow-hidden">
                  <img src={batterySystem} alt="BLUETTI EP2000" className="w-full h-auto object-cover" />
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="space-y-4">
                {essFeatures.map((feature, index) => <motion.div key={feature.title} initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
                ...
                delay: index * 0.1
              }} onClick={() => setSelectedFeature(index)} className={`flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-300 ${selectedFeature === index ? "bg-white border-[3px] border-[#00c8e0] shadow-lg" : "bg-gray-100 border-[3px] border-transparent hover:bg-gray-200"}`}>
                    ...
                    <span className={`font-semibold text-lg ${selectedFeature === index ? "text-foreground" : "text-muted-foreground"}`}>
                      {feature.title}
                    </span>
                  </motion.div>)}
              </div>
